...
contract("Lottery", (accounts) => {
    ...
    describe("enter", () => {
        ...
        it("enter 5 players and check values", async () => {
            ...
            assert.equal(await lottery.getPlayers(), [accounts[1]].toString());
            ...
            assert.equal(
                await lottery.getPlayers(),
                [accounts[1], accounts[2], accounts[3]].toString()
            );
            ...
            assert.equal(
                await lottery.getPlayers(),
                [accounts[1], accounts[2], accounts[3], accounts[4]].toString()
            );
    ...
    describe("PickWinner", async () => {
        ...
        it("Pick Winner", async () => {
            ...
            console.log(
                `account4 balance difference: ${web3.utils
                    .toBN(account4ETHBal_aft)
                    .sub(web3.utils.toBN(account4ETHBal_bef))}`
            );
            console.log(
                `account5 balance difference: ${web3.utils
                    .toBN(account5ETHBal_aft)
                    .sub(web3.utils.toBN(account5ETHBal_bef))}`
            );
        });
